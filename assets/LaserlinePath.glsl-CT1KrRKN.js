...
return abs(dist);
}`),t.spherical){const i=(a,l,d)=>m(a,l.heightManifoldTarget,d.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new S("heightManifoldOrigin",(a,l)=>(i(p,a,l),s(V,l),X(V,V,p),$(h,V),h[3]=H(V),h)),new Ve("globalOrigin",a=>s(p,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,Z(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/H(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
