import{vY as X,H9 as Z,Ha as ee,FM as te,FK as ie,Hb as re,Hc as ae,FR as o,H2 as se,Go as oe,H1 as ne,FQ as w,Hd as ce,He as le,FN as pe,FP as de,FS as he,GN as ve,FU as ue,Hf as H,Hg as N,Hh as me,Hi as fe,Gs as ge,hp as Se,FV as Pe,FW as ye,_ as _e,FX as F,FY as R,FZ as we,F_ as G,F$ as M,Gu as ze,G1 as xe,G2 as $e,G3 as be,G5 as V,G6 as Te,Hj as Ve,Hk as U,Hl as E,Hm as ke,Hn as Oe,Ho as De,G7 as We,n as p,G8 as d,hm as Ce,Gv as Fe,Hp as I,r5 as Me,GV as Le,l3 as je,Gd as Ae,dl as B,xS as He,fK as q,dx as Y,Hq as Ne}from"./index-CaNeUSZw.js";function K(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(N),S.constants.add("relativeMarkerSize","float",me/H).constants.add("relativeTipLineWidth","float",fe).code.add(o`
